    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card terms-modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-scroll-area terms-content">
          ...
          <section className="terms-section">
            <h3>第6条（ノリ打ち・打ち子・代打ちマッチングに関する自己責任）</h3>
            <p>
              1. <strong>【マッチングの許諾】</strong> 会員は、当コミュニティ内の募集フォーラム・スレッドを通じて、会員同士で「ノリ打ち」「代打ち・打ち子・引き子」「設定狙いパートナー」等の募集およびマッチングを行うことができます。
            </p>
            <p>
              2. <strong>【詐欺行為の厳禁】</strong> 登録料、保証金、預託金、情報料等の名目で事前に金銭を要求・搾取する詐欺的な募集・勧誘行為は固く禁止します。違反が確認された場合は即座にアカウントBAN（強制退会）および通報等の措置を講じます。
            </p>
            <p>
              3. <strong>【当事者間の自己責任と運営の完全免責】</strong> 当コミュニティを利用したマッチングにより生じる実戦遊技、報酬・日当の授受、出玉・収支の清算、持ち逃げ・未払い、または各ホールのハウスルール・出禁等の処分に伴う一切の損害・トラブルについて、当事者間の自己責任において解決するものとし、<strong>当コミュニティおよび運営者は一切の雇用関係、仲介責任、損害賠償責任を負いません</strong>。
            </p>
          </section>
